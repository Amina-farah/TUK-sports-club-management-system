...
<head>
    ...
    <title>Sign Up - TUK SPORTS</title>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative mx-auto" style="">
                                          <div class="col-auto d-none d-lg-block mx-auto">
                                              <img src="images/sportslogo.png" width="200" height="200">
                                          </div>
                                            <div class="col p-4 d-flex flex-column position-static text-center" style="font-family: Macondo,san-serif;">
                                              <h1 class="mb-0" style=" font-size: 2.5rem">TUK SPORTS <br>CLUB MANAGEMENT SYSTEM</h1>
                                            </div>
                                        </div>
                                        <h3 class="text-center heading" style="text-align:center; font-size: 1.4rem; "><b>Create Your TUK SPORTS CLUB Account.</b></h3>
                                        <br>
