...
<body>
    ...
    <ul class="nav nav-tabs justify-content-end" style="font-family: Bakbak One,san-serif; color: #fd7e14">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active" aria-current="page" data-bs-toggle="dropdown" ondblclick="location.href='clubs.php?id='" style="color:#ffd11a" role="button" aria-expanded="false">CLUBS</a>
    ...
    <div class="container py-5">
      <div class="row pt-md-5 pb-lg-5 justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-10 text-center py-xl-3">
          <h1>
            <span class="fw" style="color: #e6b800; text-align: center;">Welcome to <b>TUK SPORTS CLUB</b><br><br></span>
          </h1>
          <h5>
            <p class="fw-light" style="text-align: center;">
              We believe a student's life is made out of 50% study and 50% fun. That's why we offer a host of sports clubs that you're welcomed to be a part of. 
              Dabble in new experiences, spark your passion, get to know a diverse range of people and have fun - all at the same time! Sounds good already? 
              <br>Scroll down to discover all the clubs available here.
            </p>
          </h5>
        </div>
      </div>
    ...
    <h1 style="text-decoration: underline; color: #e6b800; text-align: center;">List of  sports Clubs </h1>

    <?php
      $id=$_GET["id"];
      if($id=='sports and games'){
        $query = "SELECT * FROM clubs WHERE category='sports club' ";
      }else if($id=='sports and games'){
        $query = "SELECT * FROM clubs WHERE category='sports club' ";
