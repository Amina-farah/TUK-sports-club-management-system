...
<body>
    ...
    <div class="container">
      <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none" width="auto" height="auto">
        <svg class="bi me-2" width="40" height="32"><img onclick="location.href='index.php'" src="images/sportslogo.png" style="border-radius: 10%;" alt="Logo" width="55" height="80"></svg>
        <h1 class="fs-4; a" onclick="location.href='index.php'"style="margin: 10px;font-weight: bold;">&nbsp;&nbsp;&nbsp;TUK<br>&nbsp;SPORTS CLUB MANAGEMENT SYSTEM</h1> 
      </a>
    ...
    <ul class="nav nav-tabs justify-content-end" style="font-family: Bakbak One,san-serif; color: #fd7e14">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" style="color:#737373" href="clubs.php?id=performing and creative">INDOOR GAMES</a></li> -->
    ...
    <div>
        <div class="content">
            ...
            <img src="images/sportslogo.png" class= "TUKlogo" style="width: 800px;height: 400px;border-radius: 15%; ">
                <div class="font-Times New Roman" style="display: flex;flex-direction: column;">
                    <br><br>
                    <h1 class="text-uppercase" style="font-size: 3.75rem; text-align: left;margin: .5rem .5rem;"><b>What We Provide</b></h1>
                    <p style="margin: 1rem;font-size: 1.3rem;">We are the TUK SPORTS Club .We provides students to join various type of sports that we provide. Students who joined a sports club is able to participate in several activities and event.<br></br>Sports and Games Department now offers an array of disciplines namely: rugby, basketball, handball, hockey, netball, tennis, athletics, swimming, table tennis, chess, swimming, taekwondo, volleyball, football and badminton.<br><br> NEW MEMBERS ARE ALWAYS WELCOME!!!
                    </p>
                    <br>
                </div>
            </section>
    ...
    <div class="content">
        <section style="display: flex;justify-content: center;">      
              <div class="font-Times New Roman " style="display: flex;flex-direction: column;align-items: center;text-align: center; ">
                  <br><br>
                  <h1 class="text-uppercase " style="font-size: 3.75rem; text-align: left;margin: .5rem .5rem; "><b>MISSION</b></h1>
                  <p style="margin: 1rem;font-size: 1.3rem; ">To provide students with a vibrant environment that encourages self-discovery and development, nurturing service oriented leadership.
                  </p>
                  <br>
              </div>
              <div>
                <img src="images/motiv.png" class= "club-socities" style="width: 650px;height: 400px;border-radius: 15%; ">
                  <br><br><br>
              </div>
          </section>
        </div>
        ...
        <div class="content">
            <section style="display: flex;">
            <img src="images/loggo.jfif" class= "vission" style="width: 650px;height: 400px;border-radius: 15%; ">
                <div class="font-Times New Roman" style="display: flex;flex-direction: column;">
                    <br><br>
                    <h1 class="text-uppercase" style="font-size: 3.75rem; text-align: left;margin: .5rem .5rem;"><b>    VISSION</b></h1>
                    <p style="margin: 1rem;font-size: 1.3rem;">To elevate regular participation, competitive activity and personal progression amongst the University community, and embed the philosophy of sport and activity for life.
                    </p>
                    <br>
                </div>
            </section>
   ...
   <div class="container">
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <a class="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
          <img src="images/sportslogo.png" style="border-radius: 10%;" alt="Logo" width="55" height="55">
        </a>
